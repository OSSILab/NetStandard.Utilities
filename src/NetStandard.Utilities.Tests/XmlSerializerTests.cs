...
using NetStandard.Utilities.Serialization.Xml;
using NetStandard.Utilities.Tests.Properties;
...
namespace NetStandard.Utilities.Tests
{
    ...
    {
        private XmlModelBuilder _xmlModelTypeBuilder;

        [OneTimeSetUp]
        public void InitializeSerializer()
        {
            XmlModelBuilder modelTypeBuilder = new XmlModelBuilder();
        ...
        public void Serialize_MySerializableEntityFilledWithValidData_ShouldBeEqualsWithXmlContentFrom_MySerializableEntityTest1Data()
        {
            ...
            xmlSerializer.ModelTypeBuilder = _xmlModelTypeBuilder;
            XElement serializedInstance = xmlSerializer.Serialize(mySerializableEntity);
        ...
        {
            XElement serializedEntity = XElement.Parse(Resources.MySerializableEntityTest1Data);
            XmlSerializer xmlSerializer = new XmlSerializer();
            xmlSerializer.ModelTypeBuilder = _xmlModelTypeBuilder;
